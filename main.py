...
def attack(char_name: str, char_class: str) -> str:
    """Количество нанесённого урона в зависимости от выбранного персонажа."""
...
def special(char_name: str, char_class: str) -> str:
    """Приминение специальных умений в зависимости от выбранного персонажа."""
    if char_class == 'warrior':
